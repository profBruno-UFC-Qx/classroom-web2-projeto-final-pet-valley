                    ...
                    <div class="form-section">
                        ...
                        <form @submit.prevent="updateProfile">
                            ...
                            <div class="field">
                                ...
                                <InputText v-model="userForm.document" />
                            </div>
...
import type { User, UserUpdateDTO } from '@/types/user.type'

const userStore = useUserStore()
const user = ref();
user.value = null as User | null
...
const loadUserData = async () => {
    const userData = await userStore.fetchUserByToken()
    user.value = userData;
    userForm.value = {
        name: userData.name,
...
const updateProfile = async () => {
    try {
        await userStore.updateUser(user.value?.id || "", userForm.value)
...
const changePassword = async () => {
    ...
    try {
        ...
        await userStore.updatePassword(user.value?.id || "", body);
