        ...
        <Dialog v-model:visible="visible" modal :closable="false" header="Novo Animal" style="width: 30rem">
            ...
            <form @submit.prevent="createAnimal()">
                <div class="field mb-3">
                    <label for="animal-organizationId" class="form-label">ID da Organização</label>
                    <Select id="animal-organizationId" v-model="animalForm.organizationId"
                        :options="organizationStore.organizationOptions" optionLabel="label" optionValue="value"
                        placeholder="Selecione a organização" :loading="organizationStore.loading" filter class="w-100"
                        required />
                </div>
                <div class="field mb-3">
                ...
                <div class="field mb-3">
                    ...
                    <!-- <FileUpload mode="advanced" :multiple="true" accept="image/*" :maxFileCount="5"
                        :showUploadButton="false" :showChooseButton="true" :showCancelButton="true" /> -->
                    <!-- <FileUpload mode="advanced" v-model:files="animalForm.images" :multiple="true" accept="image/*"
                        :maxFileCount="5" :showUploadButton="true" :showChooseButton="true" :showCancelButton="true"
                        :auto="false" /> -->
